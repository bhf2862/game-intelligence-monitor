...
const navItems=[['dashboard','◈','總覽','Dashboard'],['games','🎮','全部遊戲','Games'],['calendar','◷','上市日曆','Calendar'],['prices','＄','價格','Prices'],['issues','⚠','玩家問題','Issues'],['live','◉','直播','Live'],['changes','↯','重大變化','Changes'],['watchlist','★','收藏','Watchlist'],['settings','⚙','設定','Settings']];
